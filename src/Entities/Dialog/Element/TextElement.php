...
final class TextElement extends Element
{
    ...
    public static function fromArray(array $array): self
    {
        return new self(
            ...
            (int) Arr::get($array, 'max_length', 150),
    ...
    public function setSubtype(Subtype $subtype): TextElement
    {
    ...
    public function setMinLength(int $minLength): TextElement
    {
    ...
    public function setMaxLength(int $maxLength): TextElement
    {
